...
from fftoptionlib.helper import to_array_atleast_1d, to_array_with_same_dimension
...
class HelperTest(unittest.TestCase):
    def test_to_array_atleast_1d(self):
        ...
        np.testing.assert_array_equal(res[0], exp_res[0])
        np.testing.assert_array_equal(res[1], exp_res[1])
        np.testing.assert_array_equal(res[2], exp_res[2])
